package com.haaliron.fruitninjaclone;
...
public class FruitNinja extends ApplicationAdapter implements InputProcessor
{
	...
	public void render ()
	{
		...
		if (lives <= 0)
		{
			font.draw(batch,"Cut to Play",Gdx.graphics.getWidth()/2f - 150,Gdx.graphics.getHeight()/2f);
		}
		...
		if  (lives > 0)
		{
			...
			{
				batch.draw(apple,i*30f + 20f,Gdx.graphics.getHeight()-55f,35f,35f);
			}
